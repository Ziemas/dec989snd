...
typedef struct VAGStreamQueEntry { // 0x14
    /* 0x00 */ UInt32 flags;
    /* 0x04 */ SInt32 loc;
    /* 0x08 */ SInt32 offset;
    /* 0x0c */ SInt8 vol;
...
typedef struct EffectChain { // 0x10
    /* 0x0 */ UInt32 Flags;
...
typedef struct VoiceAttributes { // 0x38
