...
VAGStreamHandler *gVAGStreamHandler = NULL;
SInt32 gNumVAGStreams = 0;
SInt32 gVAGStreamingInited = 0;
UInt32 gCdSpinMode = 1;
SInt32 gHalfBufferSize = 0;
SInt32 gMasterReadBufferSize = 0;
SInt32 gMasterReadBufferFirstSector = 0;
...
SInt32 gLastVAGReadError = 0;
SInt32 gLastDATAReadError = 0;
SInt32 gReadWaitThread = -1;
SInt32 gReadIsEE = 0;
UInt32 gLastReadSector = 0;
UInt32 gLastReadAmount = 0;
UInt32 gLastReadIOPLoc = 0;
VAGStreamHeader *VAGStreamList = NULL;
VAGBuffer *VAGStreamLoadList = NULL;
VAGBuffer *VAGStreamLoadListTail = NULL;
...
SInt32 gStartDMASema = 0;
char *gSearchFileName = NULL;
sceCdlFILE *gSearchFileParams = NULL;
SInt32 gSearchFileSema = 0;
SInt32 gSearchFileResult = 0;
SInt32 gDMAThread = 0;
